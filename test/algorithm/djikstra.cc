...
#include "search/algorithm/djikstra.hh"
...
TEST(Djikstra, Single) {
  ...
  auto solution = Djikstra::Solve(graph, 0);
...
TEST(Djikstra, Multi) {
  ...
  auto solution = Djikstra::Solve(graph);
